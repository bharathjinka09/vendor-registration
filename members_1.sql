...
--
-- Host: localhost
-- Generation Time: May 05, 2020 at 01:26 PM
...
INSERT INTO `members` (`id`, `name`, `mobile`, `whatsapp`, `email`, `address`, `gstin`, `service`, `service_area`, `bank_name`, `beneficiary_name`, `account_number`, `bank_address`, `ifsc`, `payment_mode`, `id_proof`, `driving_license`) VALUES
